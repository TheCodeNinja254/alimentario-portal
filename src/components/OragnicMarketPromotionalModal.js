...
const OrganicMarketPromotionalModal = ({ setOpen }) => {
      ...
      <Grid container spacing={1}>
        <Grid item xs={12}>
          <NameTypography variant="h1" gutterBottom animate={animate}>
            We are now at the <strong>Organic Food Market</strong> Karen
          </NameTypography>
          <Typography className={classes.cardSubtitle}>
            Meet Toasted by Desafio @ Karen
          </Typography>
          <Typography variant="caption">
            Enjoy Toasted by desafio specials prepared to your taste and
            preference at the Organic Farmers Market.
          </Typography>
        </Grid>

        <Grid item xs={12}>
          <Typography className={classes.cardSubtitle}>
            Connect on Socials for more
          </Typography>
...
export default OrganicMarketPromotionalModal;
